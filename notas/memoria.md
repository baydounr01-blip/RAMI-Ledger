...
| Revisión 3 · las 7 filas, alturas nuevas (tope 1,2 celdas), binario final | **7 de 7**: Downtown a 0,3 celdas, DIFC, Jumeirah, Al Sufouh y Al Barsha a 0,9, Deira a 0,55 y Dubai Marina a 1,2; la etiqueta queda en el centro, sobre su distrito (`/tmp/ramiverif/memoria_rev3_vuelo.png`) |
